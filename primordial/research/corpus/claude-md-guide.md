# source: https://www.claudedirectory.org/blog/claude-md-guide

## The Complete Guide to CLAUDE.md: How to Configure Claude Code for Any Project
...
1. **`./CLAUDE.md`** — Project-level instructions (checked into your repo)

1. **`./src/CLAUDE.md`** — Directory-level overrides (for monorepos or large projects)

1. **`.claude/settings.json`** — Structured settings for permissions and tool configuration
...
1. Add your tech stack summary (2-3 sentences)

1. List your most-used commands

1. Add one or two conventions you find yourself repeating to Claude

1. Commit it and iterate
