# source: https://www.claudedirectory.org/blog/mcp-servers-guide

## The Complete Guide to MCP Servers: How to Give Claude Code Superpowers
...
1. **Provides resources** — data Claude can read (e.g., database schemas, API documentation)

1. **Runs locally or remotely** — on your machine, in a container, or as a hosted service
...
1. Generate the correct migration

1. Update the relevant API code

1. Create a PR with a descriptive summary
...
1. **`~/.claude/settings.json` (personal)** — Servers for individual preferences (web search, personal tools)
...
1. **Add your database** — If your project has a database, connect it. The improvement in Claude's code quality is immediate and noticeable.

1. **Add one workflow tool** — Pick the tool your team uses most (Slack, Linear, Notion) and connect it.

1. **Iterate** — Once you see how MCP servers change the way you work, you'll naturally find more to add.
